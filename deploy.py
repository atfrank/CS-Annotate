...
if __name__ == "__main__":    
    ...
    # load model
    model = dc.models.ProgressiveMultitaskClassifier(n_tasks=n_tasks,n_features=n_features,layer_sizes=[100],alpha_init_stddevs=0.04,learning_rate=0.001, model_dir=DIR_PATH+'checkpoints/', tensorboard=True, use_queue=False)
    model.restore()
